  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <img
          src="https://customer-assets.emergentagent.com/job_protect-business/artifacts/sz9lvvqy_Screenshot%202026-03-02%20at%2011.52.04%E2%80%AFPM.png"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20 py-32 md:py-40">
        <div className="max-w-4xl">
          ...
          <p className="text-lg text-gray-400 mb-12 max-w-2xl leading-relaxed">
            Professional security solutions with ex-military personnel. Trusted by businesses across Uttarakhand for over 60 years.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-20 pt-16 border-t border-white/20">
            <div className="text-center md:text-left">
              <div className="text-4xl md:text-5xl font-bold text-amber-500 mb-3">60+</div>
