          ...
          <div>
            <Link to="/" className="flex items-center space-x-2 mb-6">
              ...
              <div className="flex flex-col">
                <span className="font-bold text-xl leading-none">Shoolin</span>
                <span className="text-xs leading-none text-amber-400">Security Services</span>
              </div>
            </Link>
            ...
            <p className="text-gray-400 text-sm">
              Serving Uttarakhand since 1965 with professional security solutions.
            </p>
          </div>
