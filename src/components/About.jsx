        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          <div className="relative">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img
                src="https://customer-assets.emergentagent.com/job_protect-business/artifacts/6m4lw82i_Screenshot%202026-03-02%20at%2011.52.23%E2%80%AFPM.png"
              ...
              <div className="absolute bottom-8 left-8 right-8 bg-white/95 backdrop-blur-sm rounded-xl p-6 shadow-xl">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <div className="text-2xl font-bold text-gray-900">60+ Years</div>
